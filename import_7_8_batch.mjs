 ...
 * 支持AI Drive中7.8数据汇总表-utf8_part1.csv到part20.csv的20个分割文件批量导入
...
// 20个文件：7.8数据汇总表-utf8_part1.csv 到 7.8数据汇总表-utf8_part20.csv (注意：无前导零)
const TARGET_FILES = Array.from({ length: 20 }, (_, i) => {
  const num = i + 1;
  return `7.8数据汇总表-utf8_part${num}.csv`;
});

// 优化配置 - 针对7.8数据汇总表多文件批量导入调整（20个文件）
...
const PROGRESS_FILE = './7_8_import_progress.json'; // 7.8进度文件路径
const LOG_FILE = './7_8_import.log'; // 详细日志文件
const STATS_FILE = './7_8_import_stats.json'; // 统计数据文件
