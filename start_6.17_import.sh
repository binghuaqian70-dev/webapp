...
OUTPUT_LOG="import_6.17_output.log"
PROGRESS_FILE="6_17_import_progress.json"
STATS_FILE="6_17_import_stats.json"
LOG_FILE="6_17_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动6.17数据汇总表批量导入..."
