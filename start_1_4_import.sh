...
echo "🚀 启动1.4数据汇总表批量导入任务..."
echo "📁 文件数量: 20个 (1.4数据汇总表-utf8_part1.csv 到 part20.csv)"
...
echo ""
echo "📋 查看实时进度:"
echo "   ./check_1_4_import.sh"
echo ""
echo "📋 查看详细日志:"
echo "   tail -f 1_4_import.log"
echo ""
echo "⏹️  停止导入任务:"
echo "   kill $PID"
echo ""
echo "💡 提示: 导入任务在后台运行，您可以关闭终端"
echo "💡 进度保存在: ./1_4_import_progress.json"
echo "💡 统计数据保存在: ./1_4_import_stats.json"
echo ""
echo "⏱️  预计耗时: 约25-35分钟 (基于历史数据)"
