...
OUTPUT_LOG="import_5.13_output.log"
PROGRESS_FILE="5_9_import_progress.json"
STATS_FILE="5_9_import_stats.json"
LOG_FILE="5_9_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动5.13数据汇总表批量导入..."
