...
LOG_FILE="./11_11_import.log"
CONSOLE_LOG="./11_11_import.log.console"
PROGRESS_FILE="./11_11_import_progress.json"
STATS_FILE="./11_11_import_stats.json"
...
echo ""
echo "================================================================================"
echo -e "${BLUE}🚀 11.11数据汇总表批量导入系统${NC}"
echo "================================================================================"
echo ""
...
if ps -p $PID > /dev/null; then
    ...
    echo ""
    echo "  查看导入状态:"
    echo "    node check_11_11_import_status.mjs"
    echo ""
    echo "  停止导入进程:"
    echo "    kill $PID"
    echo ""
