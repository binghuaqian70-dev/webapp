...
const LOG_FILE = './10_15_import.log';
const STATS_FILE = './10_15_import_stats.json';
const PROGRESS_FILE = './10_15_import_progress.json';

// 预期文件信息 - 基于AI Drive扫描
const EXPECTED_RECORDS = 2031; // 实际数据行数 (不含表头)
...
function getProcessStatus() {
  try {
    ...
    const processes = execSync('ps aux | grep "optimized_batch_import.mjs" | grep -v grep', { encoding: 'utf8' });
