...
MISSING_FILES=0
for i in {1..15}; do
    FILE="/mnt/aidrive/9.1数据汇总表-utf8_part_${i}.csv"
    if [ ! -f "$FILE" ]; then
        echo "   ⚠️ 文件不存在: 9.1数据汇总表-utf8_part_${i}.csv"
