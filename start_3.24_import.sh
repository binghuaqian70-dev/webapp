...
OUTPUT_LOG="import_3.24_output.log"
PROGRESS_FILE="3_24_import_progress.json"
STATS_FILE="3_24_import_stats.json"
LOG_FILE="3_24_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动3.24数据汇总表批量导入..."
