#!/bin/bash
# verify_8_6_system.sh - 8.6数据汇总表批量导入系统完整性检查
# 检查所有依赖、文件、配置是否就绪

set -e

echo "╔════════════════════════════════════════════════════════════════╗"
echo "║   8.6数据汇总表批量导入系统 - 完整性检查脚本                  ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""

# 定义目标文件列表（16个文件）
TARGET_FILES=(
  "8.6数据汇总表-utf8_part_1.csv"
  "8.6数据汇总表-utf8_part_2.csv"
  "8.6数据汇总表-utf8_part_3.csv"
  "8.6数据汇总表-utf8_part_4.csv"
  "8.6数据汇总表-utf8_part_5.csv"
  "8.6数据汇总表-utf8_part_6.csv"
  "8.6数据汇总表-utf8_part_7.csv"
  "8.6数据汇总表-utf8_part_8.csv"
  "8.6数据汇总表-utf8_part_9.csv"
  "8.6数据汇总表-utf8_part_10.csv"
  "8.6数据汇总表-utf8_part_11.csv"
  "8.6数据汇总表-utf8_part_12.csv"
  "8.6数据汇总表-utf8_part_13.csv"
  "8.6数据汇总表-utf8_part_14.csv"
  "8.6数据汇总表-utf8_part_15.csv"
  "8.6数据汇总表-utf8_part_16.csv"
)
...
echo "📄 核心脚本检查"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
check "主导入脚本存在" "test -f import_8_6_batch.mjs"
check "主导入脚本可执行" "test -x import_8_6_batch.mjs"
check "启动脚本存在" "test -f start_8_6_import.sh"
check "进度检查脚本存在" "test -f check_8_6_import.sh"
...
if [ $fail_count -eq 0 ]; then
  ...
  echo ""
  echo "💡 下一步操作："
  echo "   ./start_8_6_import.sh     # 启动导入任务"
  echo "   ./check_8_6_import.sh     # 检查导入进度"
  exit 0
