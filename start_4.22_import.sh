...
OUTPUT_LOG="import_4.22_output.log"
PROGRESS_FILE="4_22_import_progress.json"
STATS_FILE="4_22_import_stats.json"
LOG_FILE="4_22_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动4.22数据汇总表批量导入..."
