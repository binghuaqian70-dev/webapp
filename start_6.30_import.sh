...
OUTPUT_LOG="import_6.30_output.log"
PROGRESS_FILE="6_30_import_progress.json"
STATS_FILE="6_30_import_stats.json"
LOG_FILE="6_30_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动6.30数据汇总表批量导入..."
