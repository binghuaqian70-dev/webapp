 ...
 * 支持AI Drive中7.9数据汇总表-utf8_part1.csv到part20.csv的20个分割文件批量导入
...
const TARGET_FILE_PREFIX = '7.9数据汇总表-utf8_part';
// 20个文件：7.9数据汇总表-utf8_part1.csv 到 7.9数据汇总表-utf8_part20.csv (注意：无前导零)
const TARGET_FILES = Array.from({ length: 20 }, (_, i) => {
  const num = i + 1;
  return `7.9数据汇总表-utf8_part${num}.csv`;
});

// 优化配置 - 针对7.9数据汇总表多文件批量导入调整（20个文件）
...
const PROGRESS_FILE = './7_9_import_progress.json'; // 7.9进度文件路径
const LOG_FILE = './7_9_import.log'; // 详细日志文件
const STATS_FILE = './7_9_import_stats.json'; // 统计数据文件
