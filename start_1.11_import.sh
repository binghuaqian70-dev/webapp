...
OUTPUT_LOG="import_1.11_output.log"
PROGRESS_FILE="1_11_import_progress.json"
STATS_FILE="1_11_import_stats.json"
LOG_FILE="1_11_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动1.11数据汇总表批量导入..."
