...
IMPORT_SCRIPT="import_7_9_batch.mjs"
LOG_FILE="7_9_import.log"
STATS_FILE="7_9_import_stats.json"
PROGRESS_FILE="7_9_import_progress.json"
NOHUP_LOG="7_9_import_nohup.log"
...
const TARGET_FILES = Array.from({ length: 20 }, (_, i) => {
  return \`7.9数据汇总表-utf8_part\${i + 1}.csv\`;
});
...
if (foundCount === 0) {
  ...
  console.log('💡 文件命名格式: 7.9数据汇总表-utf8_part1.csv ~ 7.9数据汇总表-utf8_part20.csv');
  process.exit(1);
}
" || exit 1
