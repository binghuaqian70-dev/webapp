...
OUTPUT_LOG="import_4.23_output.log"
PROGRESS_FILE="4_23_import_progress.json"
STATS_FILE="4_23_import_stats.json"
LOG_FILE="4_23_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动4.23数据汇总表批量导入..."
