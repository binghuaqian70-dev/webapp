...
OUTPUT_LOG="import_3.20_output.log"
PROGRESS_FILE="3_20_import_progress.json"
STATS_FILE="3_20_import_stats.json"
LOG_FILE="3_20_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动3.20数据汇总表批量导入..."
