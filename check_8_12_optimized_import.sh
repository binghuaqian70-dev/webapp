#!/bin/bash
###############################################################################
# 8.12数据汇总表批量导入进度监控脚本（优化版）
# 功能：实时查看optimized_batch_import.mjs的导入进度和统计信息
###############################################################################

STATS_FILE="/home/user/webapp/8_12_import_stats.json"
LOG_FILE="/home/user/webapp/8_12_import.log"

# 清屏
clear

echo "============================================"
echo "  8.12数据汇总表批量导入进度监控（优化版）"
echo "============================================"
echo ""
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "💡 刷新命令: watch -n 2 ./check_8_12_optimized_import.sh"
