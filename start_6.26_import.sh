...
OUTPUT_LOG="import_6.26_output.log"
PROGRESS_FILE="6_26_import_progress.json"
STATS_FILE="6_26_import_stats.json"
LOG_FILE="6_26_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动6.26数据汇总表批量导入..."
