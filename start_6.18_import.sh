...
OUTPUT_LOG="import_6.18_output.log"
PROGRESS_FILE="6_18_import_progress.json"
STATS_FILE="6_18_import_stats.json"
LOG_FILE="6_18_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动6.18数据汇总表批量导入..."
