...
OUTPUT_LOG="import_5.29_output.log"
PROGRESS_FILE="5_29_import_progress.json"
STATS_FILE="5_29_import_stats.json"
LOG_FILE="5_29_import.log"
...
start_import() {
    ...
    print_msg "$BLUE" "🚀 启动5.29数据汇总表批量导入..."
