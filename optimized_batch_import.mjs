#!/usr/bin/env node
/**
 * 优化的批量导入脚本 - 5.27数据汇总表导入版本 (多文件批量导入)
 * 后台运行、进度统计、分阶段导入策略，支持6位小数价格精度
 * 支持AI Drive中5.27数据汇总表-utf8_part1.csv到part8.csv的8个分割文件批量导入
...
const TARGET_FILE_PREFIX = '5.27数据汇总表-utf8_part';
// 8个文件：5.27数据汇总表-utf8_part1.csv 到 5.27数据汇总表-utf8_part8.csv
const TARGET_FILES = [
  '5.27数据汇总表-utf8_part1.csv', '5.27数据汇总表-utf8_part2.csv', '5.27数据汇总表-utf8_part3.csv', '5.27数据汇总表-utf8_part4.csv',
  '5.27数据汇总表-utf8_part5.csv', '5.27数据汇总表-utf8_part6.csv', '5.27数据汇总表-utf8_part7.csv', '5.27数据汇总表-utf8_part8.csv'
];

// 优化配置 - 针对5.27数据汇总表多文件批量导入调整（8个文件）
...
const PROGRESS_FILE = './5_27_import_progress.json'; // 5.27进度文件路径
const LOG_FILE = './5_27_import.log'; // 详细日志文件
const STATS_FILE = './5_27_import_stats.json'; // 统计数据文件
