#!/usr/bin/env node
/**
 * 优化的批量导入脚本 - 4.23数据汇总表导入版本 (多文件批量导入)
 * 后台运行、进度统计、分阶段导入策略，支持6位小数价格精度
 * 支持AI Drive中4.23数据汇总表-utf8_part1.csv到part15.csv的15个分割文件批量导入
...
const TARGET_FILE_PREFIX = '4.23数据汇总表-utf8_part';
// 15个文件：4.23数据汇总表-utf8_part1.csv 到 4.23数据汇总表-utf8_part15.csv
const TARGET_FILES = [
  '4.23数据汇总表-utf8_part1.csv', '4.23数据汇总表-utf8_part2.csv', '4.23数据汇总表-utf8_part3.csv', '4.23数据汇总表-utf8_part4.csv', '4.23数据汇总表-utf8_part5.csv',
  '4.23数据汇总表-utf8_part6.csv', '4.23数据汇总表-utf8_part7.csv', '4.23数据汇总表-utf8_part8.csv', '4.23数据汇总表-utf8_part9.csv', '4.23数据汇总表-utf8_part10.csv',
  '4.23数据汇总表-utf8_part11.csv', '4.23数据汇总表-utf8_part12.csv', '4.23数据汇总表-utf8_part13.csv', '4.23数据汇总表-utf8_part14.csv', '4.23数据汇总表-utf8_part15.csv'
];

// 优化配置 - 针对4.23数据汇总表多文件批量导入调整（15个文件）
...
const PROGRESS_FILE = './4_23_import_progress.json'; // 4.23进度文件路径
const LOG_FILE = './4_23_import.log'; // 详细日志文件
const STATS_FILE = './4_23_import_stats.json'; // 统计数据文件
